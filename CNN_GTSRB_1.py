...
train_dataset = torchvision.datasets.GTSRB(root='dataset',split='train',transform=transform,download=True)
test_dataset = torchvision.datasets.GTSRB(root='dataset',split='test',transform=transform,download=True)
